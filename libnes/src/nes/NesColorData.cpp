...
void NesColorData::readFullPaletteSet(const BlackT::TByte* src) {
  // Backgrounds
...
int NesColorData::readFromData(const BlackT::TByte* src) {
  readFullPaletteSet(src);
  
  return size;
}

int NesColorData::writeToData(BlackT::TByte* dst) const {
